...
UNIX BUILD NOTES FOR BITCOINAIR
====================

To build in Terminal on Debian based Linux
---------------------

	git clone https://github.com/bitcoinair/bitcoinair
	cd bitcoinair
...
This will build BitcoinAir-Qt as well if the dependencies are met.
...
Note: Currently, there is no bitcoinair ebuild available in overlay 
...
Take the following steps to build (no UPnP support):
	...
	strip src/bitcoinaird


Notes
-----
The release is built with GCC and then "strip bitcoinaird" to strip the debug
