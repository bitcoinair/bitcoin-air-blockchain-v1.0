...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("BitcoinAir-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BitcoinAir " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed.BitcoinAir.io", "seed.BitcoinAir.wkibbler.io"},
    {"seed2.BitcoinAir.io", "209.133.215.145"},
    {"74.50.121.177","seed.BitcoinAir.com"},
    {"66.165.236.74", "seed.bitcoinair.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tseedBitcoinAir", "tseed.BitcoinAir.net"},
    {NULL, NULL}
};
...
unsigned int pnSeed[] =
{
    0x91d785d1, 0xb179324a, 0x4aeca542,
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BitcoinAir is probably already running."), addrBind.ToString().c_str());
        else
