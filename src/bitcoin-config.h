...
/* Define to 1 to disable mining/minting functions */
/* #undef DISABLE_MINING */
...
/* Define this symbol if you have ipv6 build support */
#define HAVE_IPV6 1
...
#define PACKAGE_BUGREPORT "info@bitcoinair.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitcoinAir"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitcoinAir 0.8.6"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcoinair"
