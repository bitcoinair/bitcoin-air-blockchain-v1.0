...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || (uri.scheme() != QString("BitcoinAir") && uri.scheme() != QString("ppcoin")))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("BitcoinAir://"))
    {
        uri.replace(0, 11, "BitcoinAir:");
    }
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("BitcoinAir-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  BitcoinAir-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("BitcoinAir-Qt"));
