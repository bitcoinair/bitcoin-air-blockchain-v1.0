 ...
 * The BitcoinAir developers 2011-2018
 */
    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("BitcoinAir") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/BitcoinAir"));
    setWindowIcon(QIcon(":icons/BitcoinAir"));
#else
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #333333; text-align: center; color: white; border: 1px solid #4b4b4b; } QProgressBar::chunk { background: #008ff8; margin: 0px; }");
    }
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitcoinAir address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/BitcoinAir"), tr("&About BitcoinAir"), this);
    aboutAction->setStatusTip(tr("Show information about BitcoinAir"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for BitcoinAir"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/BitcoinAir"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitcoinAir addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitcoinAir addresses"));

    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Debug window"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging and diagnostic console"));

    openChatroomAction = new QAction(QIcon(":/icons/BitcoinAir"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open https://BitcoinAir.chat in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/BitcoinAir"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.BitcoinAir.net in a web browser."));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/BitcoinAir_testnet"));
            setWindowIcon(QIcon(":icons/BitcoinAir_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/BitcoinAir_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("BitcoinAir client"));
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://BitcoinAir.chat"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.BitcoinAir.net"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitcoinAir network", "", count));
}
...
{
    QString strTitle = tr("BitcoinAir"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BitcoinAir address or malformed URI parameters."),
