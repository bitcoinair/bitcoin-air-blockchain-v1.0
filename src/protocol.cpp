...
// BitcoinAir message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xf9, 0xbe, 0xb4, 0xd9 };
static unsigned char pchMessageStartBitcoinAir[4] = { 0xf5, 0xe3, 0xa2, 0xf4 };
static unsigned int nMessageStartSwitchTime = 1347300000;

unsigned char pchMessageStart[4] = { 0xf5, 0xe7, 0xa2, 0xf5 };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartBitcoinAir : pchMessageStartBitcoin, sizeof(pchMessageStartBitcoinAir));
}
