...
ACLOCAL = ${SHELL} /home/william/Desktop/raw/bitcoinair/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/william/Desktop/raw/bitcoinair/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/william/Desktop/raw/bitcoinair/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/william/Desktop/raw/bitcoinair/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/william/Desktop/raw/bitcoinair/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /home/william/Desktop/raw/bitcoinair
abs_srcdir = /home/william/Desktop/raw/bitcoinair
abs_top_builddir = /home/william/Desktop/raw/bitcoinair
abs_top_srcdir = /home/william/Desktop/raw/bitcoinair
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/william/Desktop/raw/bitcoinair/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/bitcoinaird$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/bitcoinair-qt$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win32-setup$(EXEEXT)
OSX_APP = BitcoinAir-Qt.app
OSX_DMG = BitcoinAir-Qt.dmg
OSX_DEPLOY_SCRIPT = $(top_srcdir)/contrib/macdeploy/macdeployqtplus
OSX_FANCY_PLIST = $(top_srcdir)/contrib/macdeploy/fancy.plist
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/bitcoinair.icns
OSX_PLIST = $(top_srcdir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/bitcoinair.ico \
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoinair.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/BitcoinAir-Qt
...
$(BITCOIND_BIN):
	make -C $(top_srcdir)/src bitcoinaird$(EXEEXT)

$(BITCOIN_QT_BIN):
	make -C $(top_srcdir)/src/qt bitcoinair-qt$(EXEEXT)
...
$(OSX_APP)/Contents/Resources/bitcoinair.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/BitcoinAir-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BitcoinAir-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "BitcoinAir-Qt" -no-pad -r -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BitcoinAir-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
